...
public:
    ...
    // CRAFTCRAFT item is broken at 1 durability to not make red stuff in client
    [[nodiscard]] bool IsBroken() const { return GetUInt32Value(ITEM_FIELD_MAXDURABILITY) > 0 && GetUInt32Value(ITEM_FIELD_DURABILITY) == 1; }
