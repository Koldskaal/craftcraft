...
enum ItemModType
{
    ...
    // CRAFTCRAFT spell power stat
    ITEM_MOD_HOLY_SPELL_DAMAGE = 16,
    ITEM_MOD_FIRE_SPELL_DAMAGE = 17,
    ITEM_MOD_NATURE_SPELL_DAMAGE = 18,
    ITEM_MOD_FROST_SPELL_DAMAGE = 19,
    ITEM_MOD_SHADOW_SPELL_DAMAGE = 20,
    ITEM_MOD_ARCANE_SPELL_DAMAGE = 21,
};
