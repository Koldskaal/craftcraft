...
typedef std::unordered_map<uint32, ItemUpgradeData> ItemUpgradeMap;
...
public:
    ...
    void ApplySchoolSpellPowerBonus(SpellSchools spellSchool, int32 amount, bool apply);
...
protected:
    ...
    void _SaveSecondaryClass(CharacterDatabaseTransaction trans);
    ...
    uint32 m_schoolSpellPower[MAX_SPELL_SCHOOL]; // CRAFTCRAFT specific spellpower
